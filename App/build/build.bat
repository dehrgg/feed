...
pushd %js%
del /F dist\*.min.js
ajaxmin app.js templates\feed.js templates\feedlist.js models\feedlist.js models\feed.js views\pages\search.js views\picklist.js views\feed.js views\feedlist.js views\pin-form.js -out dist\feed.min.js
popd
